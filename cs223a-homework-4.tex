...
Given that the joint position is a cubic curve, and that the derivate start and end values are zero, it means that there is one maximum in between. At this point, the second derivative is zero. Moreover, the first derivative reaches its maximum value.
