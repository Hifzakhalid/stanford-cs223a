...
Clearly not easy to draw the axis and the perpendiculars when the joints and the axis are not aligned. The schematic may become misleading at the end. According to me, the simple way to proceed is the use the definitions of the parameters.
